Packaging and Deploying write_dso
...
2. Installing the write_dso Package

A. Go to the directory that contains the file setup.py and the subdirectory write_dso. If 
...
3. Using the write_dso Package

The write_dso package is on your Python path. To import it into a Python script or 
   session, execute:
